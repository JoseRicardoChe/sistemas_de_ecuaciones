...
public class dlgTercio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Regla 1/3 de Simpson - Particular y General");
    ...
    private void btCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCalcularActionPerformed
        ...
        try {
            ...
            csMetodoTercioGenPart me = new csMetodoTercioGenPart();

            //Tabla donde se enviaran los calculos de cada iteracion
            ArrayList<csFilaTercio> o = me.Trapecio(a, b, N);
            mtTercio m = new mtTercio(o);
            this.tbIntegracion.setModel(m);
            this.txtResultado.setText(me.e()); //Corregir el metodo para enviar la aproximación en csMetodoTercioGenPart
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgTercio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
